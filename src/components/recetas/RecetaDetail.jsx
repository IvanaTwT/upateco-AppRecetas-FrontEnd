            ...
            <div className="media-content">
              <div className="card-content">
                ...
                <div className="is-flex is-align-items-center">
                  <p className="mr-6">
                    <ion-icon name="people"></ion-icon>Vistas:{" "}
                    {receta.view_count}
                  </p>
                  <p className="mr-6">
                    <ion-icon name="restaurant"></ion-icon>Preparación:{" "}
                    {receta.preparation_time} mins
                  </p>
                  <p className="mr-6">
                    <ion-icon name="time"></ion-icon>Cocción:{" "}
                    {receta.cooking_time} mins
                  </p>
                </div>
                <hr className="hr" />
              ...
              <footer className="card-footer mt-auto">
                ...
                <div className="card-footer-item">
                  <p>
                    <strong>Publicada:</strong> {formatDate(receta.created_at)}
                  </p>
                </div>
                <div className="card-footer-item">
                  <p>
